...
use a space as spaces in the name are converted to ":". After the file is in then you can just use the animation checkbox in the launcher for compile or type the command "h2tool append-animation (folder path)" in CMD.
